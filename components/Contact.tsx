        ...
        <div className="lg:w-1/2">
          ...
          <div className="space-y-6 mb-12">
            <p className="text-xl text-slate-400 leading-relaxed">
              I am currently seeking an <span className="text-white font-bold italic underline decoration-indigo-500 text-2xl">Assistant Engineer Internship</span> starting in <span className="text-indigo-400 font-bold">May 2025</span>.
            </p>
            <p className="text-xl text-slate-400 leading-relaxed">
              I am also open to <span className="text-white font-bold italic underline decoration-purple-500 text-2xl">Gap Year Program</span> opportunities starting in <span className="text-purple-400 font-bold">September 2025</span>.
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-6 group">
              ...
              <div>
                <span className="text-xs font-black uppercase tracking-[0.2em] text-slate-600">Locations</span>
        ...
        <div className="lg:w-1/2 w-full">
          <form onSubmit={handleSubmit} className="glass-morphism p-10 md:p-14 rounded-[3rem] space-y-6">
            ...
            <textarea 
              ...
              placeholder="Tell me about your internship project or offer..." required
            />
            <button 
              type="submit" 
